...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user is not None:
            return render_template("register.html", error="This Email is already Registered, Log In instead.",
    ...
    return render_template("register.html", form=form, current_user=current_user, error=None)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        return render_template("login.html", error=None, current_user=current_user, form=form)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            new_comment = Comments(text=form.comment_text.data,
